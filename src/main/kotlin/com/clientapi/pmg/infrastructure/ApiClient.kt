package com.clientapi.pmg.infrastructure
...
open class ApiClient(val baseUrl: String, val client: Call.Factory = defaultClient) {
    companion object {
        ...
        const val BASE_URL_KEY: String = "com.clientapi.pmg.baseUrl"
        @Deprecated(
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
            if (apiKey["PMGAuthCookie"] != null) {
                if (apiKeyPrefix["PMGAuthCookie"] != null) {
                } else {
                }
            }
